 ...
 * @author User
 */
public class U2_ReportFXMLController implements Initializable {
    ...
    @FXML
    private TextField nameOfOfficersTextField;
    ...
    @FXML
    private void returnHomeButtonClick(ActionEvent event) throws IOException {
        Parent root = null;
